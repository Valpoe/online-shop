...
function App() {
  ...
  const addToCart = () => toast.success('Tuote lisätty ostoskoriin!', {
    position: "top-right",
    autoClose: 4000,
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path='/Tuotteet' element={<Tuotteet setItems={setItems} items={items} getTotal={getTotal} countItem={countItem} addToCart={addToCart}/>} />
