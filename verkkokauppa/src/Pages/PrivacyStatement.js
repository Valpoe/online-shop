...
<MDBTypography tag="div" className="p-5">
    ...
    <MDBTypography tag="div" className="pb-3">Tämän sivuston artikkelit voivat sisältää upotettua sisältöä (esim. videoita, kuvia, artikkeleita jne.).
        Muiden verkkosivustojen upotettu sisältö käyttäytyy täsmälleen samalla tavalla kuin jos vierailija olisi vieraillut
        toisella verkkosivustolla.
    </MDBTypography>
   
   <MDBTypography listUnStyled className="mb-0 pb-3">
        Rekisteri saattaa sisältää seuraavia tietoja asiakkaasta:
    
    <li className="mb-1">
        <MDBIcon icon="arrow-right" className="me-2 text-warning"/>Nimi
    </li>
    <li className="mb-1">
        <MDBIcon icon="arrow-right" className="me-2 text-warning"/>Puhelinnumero
    </li>
    <li className="mb-1">
        <MDBIcon icon="arrow-right" className="me-2 text-warning"/>Sähköposti
    </li>
    <li className="mb-1">
        <MDBIcon icon="arrow-right" className="me-2 text-warning"/>IP-osoite
    </li>
    <li className="mb-1">
        <MDBIcon icon="arrow-right" className="me-2 text-warning"/>Mahdolliset annetut lisätiedot
    </li> 
    </MDBTypography>
