...
<div>
    ...
    <h1 className="PSheader">REKISTERI- & TIETOSUOJASELOSTE</h1>
    <p className="Paivitys">Päivitetty 21.3.2023</p>
    <div className="text">
    ...
    Sivustolla kerättyjä selaajatietoja käytetään sivuston palvelujen parantamiseen. Esimerkkinä mainittakoon kohdennettu mainonta. Tietojesi avulla voimme näyttää sinulle ajankohtaisempaa mainontaa ja hakutuloksia. Tietojesi avulla voimme myös analysoida sivuston liikennettä, jonka avulla voimme kehittää sivuston sisältöä ja toimivuutta paremmaksi.
    ...
    <h5 className="PSheader">1. Rekisterinpitäjä</h5>


    <h5 className="PSheader">2. Rekisteristä vastaava yhteyshenkilö</h5>


    <h5 className="PSheader">3. Rekisterin nimi</h5>
    <div className="text">
    YRITYS Oy:n markkinointi- ja analytiikkarekisteri.
    </div>

    <h5 className="PSheader">4. Oikeusperuste ja henkilötietojen käsittelyn tarkoitus</h5>
    <div className="text">
    ...
    Vierailija antaa suostumuksensa henkilötietojensa käsittelyyn tässä tietosuojaselosteessa mainittuihin tarkoituksiin lähettämällä tiedot yhteydenottokaavakkeen kautta.

    Tietoja ei käytetä automatisoituun päätöksentekoon tai profilointiin.
    </div>

    <h5 className="PSheader">5. Rekisterin tietosisältö</h5>
    <div className="text">
    <div>Tämän sivuston artikkelit voivat sisältää upotettua sisältöä (esim. videoita, kuvia, artikkeleita jne.). Muiden verkkosivustojen upotettu sisältö käyttäytyy täsmälleen samalla tavalla kuin jos vierailija olisi vieraillut toisella verkkosivustolla.</div>
    <br></br>
    <div>Rekisteri saattaa sisältää seuraavia tietoja asiakkaasta:</div>
    <ul>
        <li>Nimi</li>
        <li>Puhelinnumero</li>
        <li>Sähköposti</li>
        <li>IP-osoite</li>
        <li>Mahdolliset annetut lisätiedot</li>
    </ul>

    Verkkosivuston vierailijoiden IP-osoitteita ja palvelun toiminnoille välttämättömiä evästeitä käsitellään oikeutetun edun perusteella mm. tietoturvasta huolehtimiseksi ja sivuston vierailijoiden tilastotietojen keruuta varten niissä tapauksissa, kun niiden voidaan katsoa olevan henkilötietoja. Kolmansien osapuolten evästeille pyydetään tarvittaessa suostumus erikseen.
    </div>
    <h5 className="PSheader">6. Säännönmukaiset tietolähteet</h5>
    <div className="text">
    ...
    Rekisteriin tallennettavat tiedot saadaan asiakkaalta mm. www-lomakkeilla lähetetyistä viesteistä, sähköpostitse, puhelimitse, sosiaalisen median palvelujen kautta, sopimuksista, asiakastapaamisista sekä sivuston kävijäseurantatyökalusta, yleisesti saatavilla olevista internet-lähteistä ja muista julkisista sekä maksullisista, että maksuttomista lähteistä ja muista tilanteista, joissa asiakas luovuttaa tietojaan.

    Yritysten ja muiden organisaatioiden yhteyshenkilöiden tietoja voidaan kerätä myös julkisista lähteistä kuten verkkosivuilta, hakemistopalveluista ja muilta yrityksiltä.
    </div>
    <h5 className="PSheader">7. Tietojen säännönmukaiset luovutukset ja tietojen siirto EU:n tai ETA:n ulkopuolelle</h5>
    <div className="text">
    ...
    <h5 className="PSheader">8. Rekisterin suojauksen periaatteet</h5>
    <div className="text">
    Rekisterin käsittelyssä noudatetaan huolellisuutta ja tietojärjestelmien avulla käsiteltävät tiedot suojataan asianmukaisesti. Kun rekisteritietoja säilytetään Internet-palvelimilla, niiden laitteiston fyysisestä ja digitaalisesta tietoturvasta huolehditaan asiaankuuluvasti. Rekisterinpitäjä huolehtii siitä, että tallennettuja tietoja sekä palvelimien käyttöoikeuksia ja muita henkilötietojen turvallisuuden kannalta kriittisiä tietoja käsitellään luottamuksellisesti ja vain niiden työntekijöiden toimesta, joiden työnkuvaan se kuuluu.
    </div>
    <h5 className="PSheader">9. Tarkastusoikeus ja oikeus vaatia tiedon korjaamista</h5>
    <div className="text">
    ...
    <h5 className="PSheader">10. Evästeet</h5>
    <div className="text">
