                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-8">
                            ...
                            charitable initiatives. We believe that education is the key to success, and we are committed to making it accessible to everyone, regardless of their background or financial circumstances.
                            </p>
                        </div>
                        <div className="col-md-4 d-flex align-items-center">
                            <img width="450" height="450" src={kouluTarvikkeet} alt="koulutarvikkeet"></img>
                        </div>
                    </div>
                </div>
            </section>
